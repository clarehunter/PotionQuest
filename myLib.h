...
// Character animation states for aniState
enum {FRONT, LEFT, RIGHT, BACK, IDLE};
...
#define BLD_TOP2     (1<<2)
#define BLD_TOP3     (1<<3)
#define BLD_TOPOBJ   (1<<4)
#define BLD_TOPBD    (1<<5)
#define BLD_OFF      (0<<6)
#define BLD_STD      (1<<6)
#define BLD_WHITE    (10<<6)
#define BLD_BLACK    (11<<6)
#define BLD_BOT0     (1<<8)
#define BLD_BOT1     (1<<9)
#define BLD_BOT2     (1<<10)
#define BLD_BOT3     (1<<11)
#define BLD_BOTOBJ   (1<<12)
#define BLD_BOTBD    (1<<13)

// White/Black Blending Weight Register
...
#define BLDY3         (1<<3)
#define BLDY4         (1<<4)
#define BLDY(weight)  (weight<<0)

// Standard Alpha Blending Weights Register
...
#define BLD_EVA3         (1<<3)
#define BLD_EVA4         (1<<4)
#define BLD_EVA(weight)  (weight<<0)
#define BLD_EVB0         (1<<8)
#define BLD_EVB1         (1<<9)
#define BLD_EVB2         (1<<10)
#define BLD_EVB3         (1<<11)
#define BLD_EVB4         (1<<12)
#define BLD_EVB(weight)  (weight<<8)
