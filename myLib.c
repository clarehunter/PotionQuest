...
// Sets up the interrupts for playing sound
...
// Handles sound-related interrupts
    ...
    if(REG_IF & INT_VBLANK) {
        if (soundA.isPlaying) {
            ...
            if (soundA.vBlankCount > soundA.duration) {
                ...
                // Check whether or not the sound loops
                if (soundA.loops) {
